...
custom_formatter=plt.FuncFormatter(labeller)
...
plt.text(100,0.11,"40%",fontsize='10')
plt.text(100,0.16,"30%",fontsize='10')
plt.text(100,0.22,"20%",fontsize='10')
plt.text(100,0.3,"15%",fontsize='10')
plt.text(100,0.4,"10%",fontsize='10')
plt.text(100,0.54,"5%",fontsize='10')
plt.text(100,1.2,"2%",fontsize='10')
plt.text(100,2.6,"1%",fontsize='10')
plt.text(0.11,100,"40%",fontsize='10')
plt.text(0.16,100,"30%",fontsize='10')
plt.text(0.22,100,"20%",fontsize='10')
plt.text(0.3,100,"15%",fontsize='10')
